...
class Project(models.Model, BaseModel):
    ...
    scm_login = models.ForeignKey('ServiceLogin', related_name='projects', on_delete=models.SET_NULL, null=True, help_text="... or add an SSH key in the next tab", blank=True)
