...
class Project(models.Model, BaseModel):
    ...
    scm_login = models.ForeignKey('ServiceLogin', related_name='projects', on_delete=models.SET_NULL, null=True, help_text="... or leave this blank and add an SSH key", blank=True)
